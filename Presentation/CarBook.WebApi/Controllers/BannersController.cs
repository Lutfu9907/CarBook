...
namespace CarBook.WebApi.Controllers
{
    ...
    public class BannersController : ControllerBase
    {
        ...
        public BannersController(GetBannerByIdQueryHandler getBannerByIdQueryHandler,
            GetBannerQueryHandler getBannerQueryHandler, UpdateBannerCommandHandler updateBannerCommandHandler,
            RemoveBannerCommandHandler removeBannerCommandHandler, CreateBannerCommandHandler createBannerCommandHandler)
        {
